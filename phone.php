...
<body>
    ...
    <div class="cover-container">
        <div class="inner cover">
            <h1 class="cover-heading"> <i class="fa fa-clock-o fa-fw"></i>  Введите номер телефона  </h1>
            <p class="lead"></p>
            <label class="lead" for="phoneNumber">  Введите номер телефона:  </label>
    <input type="text" id="phoneNumber" placeholder="  Введите номер телефона ">
    <p class="lead"><a href="process.php" class="btn btn-lg btn-default">Отправить</a></p>
